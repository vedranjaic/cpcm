...
gulp.task('install', ['styles', 'styles-dist', 'styles-min-dist', 'fileinclude', 'app-js', 'js-vendors', 'images', 'favicon', 'fonts']);


// --- [ PRODUCTION ]
// gulp production - compresses .css, combines all .js into _app.js and minifies, optimizes all images and svgs
gulp.task('production', ['styles-min', 'js-concat', 'js-min', 'image-min', 'svg-min'])
